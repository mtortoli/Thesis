...
\begin{enumerate}
	\item \textit{Step 1}: Trovare il minimo elemento in una matrice di dimensione $n \times n$.
	\newline
	...
	\[T(step 3)=O(n/2)\]
\end{enumerate}
Adesso basta sommare le tre complessità e si trova quella totale dell'algoritmo:
