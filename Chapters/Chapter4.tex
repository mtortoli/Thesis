...
\[D^\star = \bordermatrix{\text{specie}&f&b&u&s\cr
                ...
                s& -14 & -12 & -16 & 0}
\]
Nel \textit{secondo} step si cerca l'elemento minimo in $D^\star$, ovvero $D_{fb}$\footnote{Anche $D_{us}$ è l'elemento più piccolo, tuttavia non si possono scegliere più elementi alla volta.}, le cui foglie $f$ e $b$ sono \textit{vicine}.
\newline
Nel \textit{terzo} invece bisogna calcolare il delta blabla