...
\hyphenation{di-stan-za}
\hyphenation{co-stru-i-sce}
...
\bibitem{bioinfvideoAdditive}
Compeau P.\newline
\textit{Additive Phylogeny}.
\\\texttt{\url{https://www.youtube.com/watch?v=HjDz2ak5BUk&t=263s}}.\newline
University of California, San Diego, 2015.

\bibitem{LeastSquaresAlgorithmCompeauVideo}
Compeau P.\newline
\textit{Using Least-Squares to Construct Distance-Based Phylogenies}.
\\\texttt{\url{https://www.youtube.com/watch?v=DnmsL-WxK5s&list=PLQ-85lQlPqFPhJxNcuSOxLTNmbp3NzVtU&index=5}}.\newline
University of California, San Diego, 2015.
...
\bibitem{cambridgeBioInf}
Frost S.\newline
\textit{BioInformatics algorithms}.
\\\texttt{\url{https://www.cl.cam.ac.uk/teaching/1718/Bioinfo/bioinfo2017.pdf}} \newline
University of Cambridge, Department of Computer Science and Technology, 2017.
...
\bibitem{UniCaliforniaadditivetree}
UC Davis Academics.\newline
